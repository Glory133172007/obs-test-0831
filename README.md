...
> 请注意，上传/下载时，地址类参数请不要使用操作系统独有的地址符号（如Linux系统的'\~，会被识别成名为'\~'的文件夹'）。如果想便捷使用某个地址，建议使用[action提供的上下文功能](https://docs.github.com/cn/actions/learn-github-actions/contexts#github-context)中提供的上下文，例如：
